...
def balotera(balotas):
    ...
    while len(balota)<24:
        ...
        rand= random.choice(balotas)
        if rand[0] == 'B' and b<5:
            balota.append(rand)
            b +=1
        elif rand[0] == 'I' and i<5:
            balota.append(rand)
            i +=1
        elif rand[0] == 'N' and n<4:
            balota.append(rand)
            n +=1
        elif rand[0] == 'G' and g<5:
            balota.append(rand)
            g +=1
        elif rand[0] == 'O' and o<5:
            balota.append(rand)
            o +=1
        
        balotas_minimas = tuple(balota)

    return balotas_minimas
